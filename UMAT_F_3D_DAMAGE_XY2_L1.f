...
C
      #include 'DAMAGE/DAMAGE_3D_XY2_HOOKE.f'
      #include 'DAMAGE/DAMAGE_3D_XY2_FORCES.f'
C
      #include 'DAMAGE_LAWS/DAMAGE_LAW1.f'
C
C ABAQUS UMAT_3D_DAMAGE_XY2 SUBROUTINE
C
...
C
      CALL ADD_VEC(TSTRAN, STRAN, DSTRAN, NTENS)
      CALL DAMAGE_3D_XY2_FORCES(Y1, Y2, TSTRAN, E1, E2, E3, nu12, nu13,
     1 nu23, G12, G13, G23, d1, d2)
      CALL DAMAGE_LAW1(d1, Y1, Y10, Y11)
      CALL DAMAGE_LAW1(d2, Y2, Y20, Y21)
C
      dmax = 1. - 1e-6
      IF (d1 > dmax) THEN
        d1 = dmax
...
!       PRINT *, "d2 =", d2
C
      CALL DAMAGE_3D_XY2_HOOKE(DDSDDE, E1, E2, E3, nu12, nu13, nu23,
     1 G12, G13, G23, d1, d2)
